...
export const PROVIDER_SERVICES: Record<string, Record<string, ServiceEntry>> = {
  gcp: {
    ...
    audit: { name: "Cloud Logging", icon: "/icons/gcp/cloudlogging.png" },
    ...
    flowlogs: { name: "Cloud Monitoring", icon: "/icons/gcp/cloudmonitoring.png" },
    ...
    network: { name: "Cloud CDN", icon: "/icons/gcp/cloudcdn.png" },
    ...
    tracing: { name: "Cloud Monitoring", icon: "/icons/gcp/cloudmonitoring.png" },
  ...
  azure: {
    ...
    network: { name: "Azure Front Door", icon: "/icons/azure/frontdoor.png" },
